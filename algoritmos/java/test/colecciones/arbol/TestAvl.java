...
public class TestAvl {
    ...
    public void testInsertarMuchos() {
        Integer[] a = { 477, 1193, 2130, 398, 1393, 946, 422, 1381, 1767, 830, 570, 1085, 741, 598, 1658, 1801, 487,
                1921, 1918, 258, 135, 975, 1870 };
        ...
        assertEquals(1801,
                (int) arbol.subArbolDerecho().subArbolDerecho().subArbolIzquierdo().subArbolIzquierdo().raiz());
