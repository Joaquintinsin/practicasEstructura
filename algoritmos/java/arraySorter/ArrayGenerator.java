...
public final class ArrayGenerator {
    ...
    * 
    * <pre>generarArreglo({@code
    * min
    * }, {@code
    * max
    * }, {@value #DEFAULT_LONGITUD}, {@code
    * System.currentTimeMillis()
    * })</pre>
    * 
    * @param min el limite inferior del rango de valores a generar
    * @param max el limite superior del rango de valores a generar, no puede ser
    *            menor a {@code min}
    * @return un arreglo de {@value #DEFAULT_LONGITUD} enteros aleatorios generados
    *         a partir de {@code System.currentTimeMillis()}
   ...
   /**
    * Genera un arreglo de enteros con valores aleatorios, utilizando una semilla
    * particular.
    * Este método es equivalente a
    * 
    * <pre>generarArreglo({@code
    ...
    * 
    * @param min     el limite inferior del rango de valores a generar
    * @param max     el limite superior del rango de valores a generar, no puede
    *                ser menor a {@code min}
    * @param semilla la semilla utilizada por el generar aleatorio para la
    *                secuencia pseudo aleatoria, la misma semilla va a generar el
    *                mismo arreglo
    * @return un arreglo de {@value #DEFAULT_LONGITUD} enteros aleatorios generados
    *         a partir de {@code semilla}
    */
   ...
   /**
    * Genera un arreglo de enteros con valores aleatorios, de una longitud
    * particular.
    * Este método es equivalente a
    * 
    * <pre>generarArreglo({@code
    ...
    * @param max      el limite superior del rango de valores a generar, no puede
    *                 ser menor a {@code min}
    * @param longitud la cantidad de enteros que va a tener el arreglo, debe ser
    *                 mayor o igual a {@code 0}
    * @return un arreglo de {@code longitud} enteros aleatorios generados a partir
    *         de {@code System.currentTimeMillis()}
    * @see System#currentTimeMillis()
    */
   ...
   /**
    * Genera un arreglo de enteros con valores aleatorios, de una longitud
    * particular, y utilizando una semilla particular.
    * 
    * @param min      el limite inferior del rango de valores a generar
    * @param max      el limite superior del rango de valores a generar, no puede
    *                 ser menor a {@code min}
