...
/**
 * Diccionario, representa un grafo dirigido acíclico siguiendo las siguientes
 * reglas de construcción:
 * <ul>
 * <li>Un árbol vacío se representa por no tener ningún nodo asociado.</li>
 * <li>Un árbol no vacío se representa por un nodo inicial con dos subárboles
 * disjuntos asociados, uno considerado como izquierdo, y otro como
 * derecho.</li>
 * <li>Todo nodo tiene un valor de tipo {@code T} asociado.</li>
 * <li>Para todo nodo se debe cumplir que el máximo valor de los nodos del
 * subárbol izquierdo debe ser menor al valor asociado a este.</li>
 * <li>Para todo nodo se debe cumplir que el mínimo valor de los nodos del
 * subárbol derecho debe ser mayor al valor asociado a este.</li>
 * <li>Todo nodo en el árbol debe ser alcanzable desde la raíz por un único
 * camino.</li>
 * </ul>
 * 
 * @param <T> el tipo del valor asociado a los nodos del árbol, debe ser posible
...
public interface Diccionario<T> {
    ...
    * <li>La altura de un árbol no vacío es {@code 1 + } el máximo de las alturas
    * de los sub arboles izquierdo y derecho</li>
    * </ul>
    * 
   ...
   /**
    * El sucesor de un elemento {@code elem} en el árbol es el elemento más pequeño
    * mayor que elem.
    * 
   ...
   /**
    * El predecesor de un elemento {@code elem} en el árbol es el elemento más
    * grande menor que elem.
    * 
    ...
    * <ul>
    * <li>No hay ciclos, no se puede alcanzar a un nodo a partir de sus
    * descendientes.</li>
    * <li>Todo nodo tiene a lo sumo dos descendientes (uno izquierdo y uno derecho)
    * y no pueden ser iguales.</li>
    * <li>Todo nodo en un árbol no vacío es alcanzable desde la raíz.</li>
    * <li>Para cada nodo en el árbol existe un solo camino para alcanzarlo desde la
    * raíz.</li>
    * <li>La cantidad de nodos en el árbol debe ser igual al resultado del método
    * {@code elementos()}.</li>
    * <li>Los nodos del arbol se organizan en un orden total y deben cumplir que:
    * <ul>
    * <li>El subarbol izquierdo de un nodo contiene solo nodos con valores menores
    * que el valor del nodo.</li>
    * <li>El subarbol derecho de un nodo contiene solo nodos con valores mayores
    * que el valor del nodo.</li>
   ...
   /**
    * Compara dos árboles binarios, la comparación contempla no solo los valores
    * almacenados, sino también la estructura.
    * 
   ...
   /**
    * Retorna una lista con los elementos almacenados en este árbol usando un
    * recorrido {@code INORDER}.
    * <p>
    * Llamar a este método es equivalente a llamar a
    * 
    * <pre>
    * aLista(Orden.INORDER)
    * </pre>
    * 
    * @return retorna una lista con los elementos de este árbol según un recorrido
    *         {@code INORDER}.
    */
   List<T> aLista();
    ...
    * 
    * @param orden define el recorrido que se va a utilizar para recolectar los
    *              valores.
    * @return retorna una lista con los elementos de este árbol según el recorrido
    *         definido por {@code orden}.
    */
