...
public class ArraySorter {
  ...
  public static <T extends Comparable<? super T>> void shellSort(T[] array) {
    if (array == null) throw new UnsupportedOperationException("El arreglo a ordenar no puede ser null");
  ...
  public static <T extends Comparable<? super T>> void quickSort(T[] array, int leftmost, int rightmost) {
    ...
    if (leftmost < rightmost) {
      int pivot = (leftmost + rightmost) % 2;
      quickSort(array, leftmost, part-1);
      quickSort(array, part+1, rightmost);
    }
  }
  
  /*private static <T extends Comparable<? super T>> int particion(T[] array, int leftmost, int rightmost) {
    T pivot = array[rightmost];
    int i = (leftmost - 1);
